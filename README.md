...
### 开发原因
- 早在2018年,本人便在南宁市东盟中学就读,期间使用.bat文件执行命令来试图关闭学生端程序,可视为本项目的前身与灵感来源.
- 2021年由于种种原因,教师关闭了学生机使用任务管理器/注册表管理器与命令提示符的权限,原方法失效.
...
### 更新日志
- 3.0.0.2(本质上是回滚到2.0.4.1重做，抛弃了3.0.0.1的内容)-全家桶史诗性更新（通过时钟周期事件伪装在线，杀死凌波防止极域重启），修复了3.0.0.1的BUG，回归经典界面
